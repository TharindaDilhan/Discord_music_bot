...
let rowss = new MessageActionRow()
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**Title:** [${song.title}](${song.url}) \n\n **Song Duration** ${np} minutes    **Status:** **Playing** \n\n *Only author can skip and loop song*`)
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**Title:** [${song.title}](${song.url}) \n\n **Song Duration** ${np} minutes    **Status:** **Finished** `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
...
const { channel } = message.member.voice;
      ...
      const embed4 = new MessageEmbed()
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**Title:** [${song.title}](${song.url}) \n\n **Song Duration** ${np} minutes                 **Status:** Resumed by ${b.clicker.member} \n\n *Only author can skip and loop song* `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
      ...
      const embed2 = new MessageEmbed()
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**Title:** [${song.title}](${song.url}) \n\n **Song Duration:** ${np} minutes               **Status:** Paused by ${b.clicker.member} \n\n *Only author can skip and loop song* `)
                    .setFooter(`Played by: ${message.member.displayName}`, message.author.displayAvatarURL());
                    ...
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**Title:** [${song.title}](${song.url}) \n\n **Song Duration** ${np} minutes                   **Status:** Skiped by ${b.clicker.member} `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
